...
<body>
    <div class="wrapper">
        ...
        <main class="content">
            <h1>Visiting Lecturer Management</h1>
            ...
            <a href="manage_student_assignments.php" style="display: inline-block; padding: 10px 16px; background-color: #3bba9c; color: white; text-decoration: none; border-radius: 5px; margin-bottom: 20px;">
                Assign Students
            </a>
